...
/// "the probability this ball says yes". Constructing a scale with garbage
/// input (negatives, all zeros) falls back to an even three-way split rather
/// than trapping — the ball should never be able to crash the app.
...
public struct ScalePreset: Identifiable, Hashable, Sendable {
    ...
    public static let all: [ScalePreset] = [
        ...
        ScalePreset(
            id: "fog",
            name: "Cosmic Fog",
            detail: "The ball is mostly undecided today.",
