...
public struct Oracle: Sendable {
    ...
    /// Ask the ball. The same question, scale and day produce the same answer.
    ///
    ...
    func answers(sentiment: Sentiment, allowedPackIDs: Set<String>) -> [Answer] {
        ...
        // subscription mid-session). Falling back to Classic keeps the ball
