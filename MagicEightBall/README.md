...
A Magic 8 Ball for iOS that shows you the odds behind every answer — and lets
you change them.

Ask a yes-or-no question, shake or tap, and the ball answers. Every reading
also reports the probability that produced it, so you always know whether the
ball was leaning your way. Free tier is a complete app; Pro unlocks unlimited
...
voice of the ball but never its luck.** There's a test that asserts exactly
...
scale, produces the same answer. The ball doesn't change its mind, and
