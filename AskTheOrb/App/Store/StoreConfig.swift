...
enum StoreConfig {
    static let monthlyID = "com.asktheorb.pro.monthly"
    static let annualID = "com.asktheorb.pro.annual"
    static let lifetimeID = "com.asktheorb.pro.lifetime"
    ...
    static let privacyURL = URL(string: "https://asktheorb.app/privacy")!
    static let supportURL = URL(string: "https://asktheorb.app/support")!
}
